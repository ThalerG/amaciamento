...
c = clock;
fsave = [rt 'Ferramentas\Arquivos Gerados\wavelet_graphTest_' num2str(c(1)-2000) num2str(c(2),'%02d') num2str(c(3),'%02d') '_' num2str(c(4),'%02d') num2str(c(5),'%02d') '\'];
...
for k1 = amStart:length(path)
    ...
    for k2 = 1:length(path{k1})
        ...
        [n,ta] = runin_detect_wav(dataF,t,w,n,r,s,f);
