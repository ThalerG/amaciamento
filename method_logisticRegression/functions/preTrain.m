...
for k1 = 1:length(EnData)
    ...
    for k2 = 1:length(EnData{k1})
        ...
        for v = 1:length(varNames)
            var = varNames{v};
            if ~(((strcmp(EnData{k1}(k2).name(1:10),"Amostra B5"))&&(any(strcmp(varNames,"vaz"))))||... % Ensaios com falhas nos dados
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B7"))&&(any(strcmp(varNames,"cRMS"))))||...
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B8"))&&(any(strcmp(varNames,"vInfRMS"))))||...
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B8"))&&(any(strcmp(varNames,"vInfKur"))))||...
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B8"))&&(any(strcmp(varNames,"vInfVar"))))||...
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B8"))&&(any(strcmp(varNames,"vSupRMS"))))||...
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B8"))&&(any(strcmp(varNames,"vSupKur"))))||...
                 ((strcmp(EnData{k1}(k2).name(1:10),"Amostra B8"))&&(any(strcmp(varNames,"vSupVar")))))
                switch char(var)
                    case 'cRMS'
