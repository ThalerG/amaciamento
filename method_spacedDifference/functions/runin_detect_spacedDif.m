function [n,ta] = runin_detect_spacedDif(x,t,w,n,d_lim,r,f)
%  runin_detect_spacedDif indicates the SST using a spaced difference test
%
%   [n,ta] = runin_detect_singleavg(x,t,w,d_lim,r,f): Estimates the steady
...
%   The SST is assumed when the difference is smaller than d_lim for at least r samples, 
