...
switch selMethod % Rankeia os resultados pela métrica selecionada
    case 'ROC_AUC'
        preProcAnTable = sortrows(preProcAnTable,'ROC_AUC_Train','descend','MissingPlacement','last');
    case 'Fbeta'
        preProcAnTable = sortrows(preProcAnTable,'fselBeta_Train','descend','MissingPlacement','last');
    case 'MCC'
        preProcAnTable = sortrows(preProcAnTable,'MMC_Train','descend','MissingPlacement','last');
    otherwise
...
switch selMethod % Rankeia os resultados pela métrica selecionada
    case 'ROC_AUC'
        featSelAnTable = sortrows(featSelAnTable,'ROC_AUC_Train','descend','MissingPlacement','last');
    case 'Fbeta'
        featSelAnTable = sortrows(featSelAnTable,'fselBeta_Train','descend','MissingPlacement','last');
    case 'MCC'
        featSelAnTable = sortrows(featSelAnTable,'MMC_Train','descend','MissingPlacement','last');
    otherwise
        error(['Performance metric "', selMethod,'" not recognized'])
end
...
switch selMethod % Rankeia os resultados pela métrica selecionada
    case 'ROC_AUC'
        analysisMLAnTable = sortrows(analysisMLAnTable,'ROC_AUC_Train','descend','MissingPlacement','last');
    case 'Fbeta'
        analysisMLAnTable = sortrows(analysisMLAnTable,'fselBeta_Train','descend','MissingPlacement','last');
    case 'MCC'
        analysisMLAnTable = sortrows(analysisMLAnTable,'MMC_Train','descend','MissingPlacement','last');
    otherwise
        error(['Performance metric "', selMethod,'" not recognized'])
end
